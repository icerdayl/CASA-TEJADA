        ...
        resolver
            ...
            .tapAsync("ExportsFieldPlugin", (request, resolveContext, callback) => {
                ...
                try {
                    ...
                    // field â€” and `null` is cached for description files that
                ...
                // otherwise-valid target â€” then we fall back instead of erroring.
                ...
                forEachBail(
                    ...
                    (err, result) => {
                        ...
                        if (!result) {
                            ...
                            // out â€” return no result so the next `modules` entry is tried.
