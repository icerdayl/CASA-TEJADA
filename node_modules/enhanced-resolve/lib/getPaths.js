 ...
 *
 * The return value may be shared across callers via `getPathsCached` â€” treat
 ...
 * does not change the hidden-class shape of `pathCache` â€” which is accessed
 * on the hot path of every resolve as `resolver.pathCache.{join,dirname,
 * basename}.fn(...)`. CodSpeed caught that shape change as a ~1â€“2%
...
/**
 * Memoized `getPaths`. The returned object is shared across callers â€” do
