    ...
    apply(resolver) {
        ...
        resolver
            ...
            .tapAsync("SymlinkPlugin", (request, resolveContext, callback) => {
                ...
                // when `fs.readlink` succeeds â€” which is rare (the vast majority
                ...
                forEachBail(
                    ...
                    (path, callback) => {
                        ...
                        fs.readlink(path, (err, result) => {
                            if (!err && result) {
                                // First symlink seen â€” take our own copy now, so
                    ...
                    (err, idx) => {
                        ...
                        resolver.doResolve(
                            ...
                            (err, innerResult) => {
                                ...
                                // resolving it produced a result, use it. If it did not â€”
                                // e.g. a `restrictions` rule rejected the real target â€”
