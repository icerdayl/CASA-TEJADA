...
}, "HookMap#tap(key,â€¦) is deprecated. Use HookMap#for(key).tap(â€¦) instead.");
...
}, "HookMap#tapAsync(key,â€¦) is deprecated. Use HookMap#for(key).tapAsync(â€¦) instead.");
...
}, "HookMap#tapPromise(key,â€¦) is deprecated. Use HookMap#for(key).tapPromise(â€¦) instead.");
